...
export default function ContactContent() {
  ...
  function updateClipboard(e) {
    navigator.clipboard.writeText("hello@adamdurrant.co.uk").then(
      function () {
  ...
  return (
    <>
      <div className={styles.row}>
        ...
        <div className={styles.buttonPair}>
          <a
            ...
            href='mailto:hello@adamdurrant.co.uk'
            target='_blank'
      ...
      <div className={styles.row}>
        ...
        <a
          href='https://cal.com/adam-durrant-z9wzhk/15min'
          target='_blank'
          rel='noopener noreferrer'
          className={
      ...
      <div className={styles.row}>
        ...
        <div className={styles.flexRow}>
          ...
          <a
            className={styles.textButton}
            href='https://github.com/adamddurrant'
            target='_blank'
            rel='noopener noreferrer'
          >
            <Image
